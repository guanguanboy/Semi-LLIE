...
class MultiscaleFeatsExtractor(nn.Module):
...
if __name__ == '__main__':
    ...
    model_extractor = MultiscaleFeatsExtractor(16, 32)
    model_extractor = model_extractor.to(device=device)

    outputs_1, outputs_2, outputs_3, outputs_4 = model_extractor(inputs)

    print(outputs_1.shape, outputs_2.shape, outputs_3.shape, outputs_4.shape)
