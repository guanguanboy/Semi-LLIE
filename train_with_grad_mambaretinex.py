...
from model_retinexmamba import RetinexMamba
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', default='./model/ckpt_begin_0603_on_myLSRW_with_mambaretinex/', type=str)
