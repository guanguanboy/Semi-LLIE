...
from model_mambair import MambaIR
def main(gpu, args):
    args.local_rank = gpu
    # random seed
    setup_seed(2022)
    ...
    net = MambaIR(img_size=256)
    ema_net = MambaIR(img_size=256)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', default='./model/ckpt_begin_0603_on_myLSRW_with_mamba/', type=str)
